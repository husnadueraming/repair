      ...
      <div class="col py-sm-5">
        <div class="card ">
          ...
          <div class="card-body bg-light">
            <form action="saveProfile_user.php" method="POST" enctype="multipart/form-data">
              <div class="table-responsive">
                <table class="table table-borderless">
                  ...
                  <tbody>
                    <tr>
                      <td><b>ชื่อ</b></td>
                      <td><input type="text" class="form-control" name="txtFname" value="<?=$objResult["Firstname"];?>">  </td>
                    </tr>
                    <tr>
                      <td><b>นามสกุล</b></td>
                      <td><input type="text" class="form-control" name="txtLname" value="<?=$objResult["Lastname"];?>"></td>
                    </tr>
                    <tr>
                      <td><b>หน่วยงาน</b></td>
                      <td><input type="text" class="form-control" name="txtDep" value="<?=$objResult_["Department"];?> "></td>
                    </tr>
                    <tr>
                      <td><b>เบอร์โทร</b></td>
                      <td><input type="text" class="form-control" name="txtTel" value="<?=$objResult["Tel"];?>"> </td>
                    </tr>
                    <tr>
                    <tr>
                      <td><b>อีเมล</b></td>
                      <td><input type="email" class="form-control" name="txtEmail" value="<?=$objResult["email"];?>"> </td>
                    </tr>
                    <tr>
                      <td><b>Username</b></td>
                      <td><input type="text" class="form-control" name="txtUsername" value="<?=$objResult["Username"];?>"> </td>
                    </tr>
                    <tr>
                      <td><b>Password</b></td>
                      <td><input type="password" class="form-control" name="txtPassword" value="<?=$objResult["Password"];?>"> </td>
                    </tr>
                    <tr>
                      <td><b>Confirm Password</b></td>
                      <td><input type="password" class="form-control" name="txtConPassword" id="txtConPassword" value="<?php echo $objResult["Password"];?>">
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <img src="uploads/<?=$objResult["image"]?> " class="img-fluid rounded-circle" width="150" height="150">
                      </td>
                      <td>
                ...
                <p align="center">
                  <button type="submit" name="submit" class="btn btn-success" onClick="return confirm('ยืนยันการบันทึกข้อมูลใช่หรือไม่'); document.getElementById('elect')">บันทึก</button>
                </p>
              </div>
            </form>
          </div>
